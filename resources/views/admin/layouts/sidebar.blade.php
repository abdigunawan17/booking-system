<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class=""><a class="nav-link" href="{{ route('admin_slider_view') }}"><i class="fas fa-hand-point-right"></i> <span>Slider</span></a></li>

            <li class=""><a class="nav-link" href="{{ route('admin_post_view') }}"><i class="fas fa-hand-point-right"></i> <span>Post</span></a></li>
