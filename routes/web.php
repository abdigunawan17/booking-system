...
use App\Http\Controllers\Admin\AdminSubcribeController;
...
Route::post('/subcriber/send_email', [SubcriberController::class, 'send_email'])->name('subcribe_send_email');

Route::get('/subcriber/verify/{email}/{token}', [SubcriberController::class, 'verify'])->name('subcribe_verify');
...
Route::group(['middleware' => ['admin:admin']], function() {
    ...
    Route::get('/admin/slide/view', [AdminSliderController::class, 'index'])->name('admin_slider_view');

    Route::get('/admin/slide/add', [AdminSliderController::class, 'add'])->name('admin_slider_add');

    Route::post('/admin/slide/store', [AdminSliderController::class, 'store'])->name('admin_slider_store');

    Route::get('/admin/slide/edit/{id}', [AdminSliderController::class, 'edit'])->name('admin_slider_edit');

    Route::post('/admin/slide/update/{id}', [AdminSliderController::class, 'update'])->name('admin_slider_update');

    Route::get('/admin/slide/delete/{id}', [AdminSliderController::class, 'delete'])->name('admin_slider_delete');
    ...
    Route::get('/admin/page/termcond', [AdminPageController::class, 'termcond'])->name('admin_page_termcond');

    Route::post('/admin/page/termcond/update', [AdminPageController::class, 'termcond_update'])->name('admin_page_termcond_update');
    ...
    Route::get('/admin/page/photo-gallery', [AdminPageController::class, 'photo_gallery'])->name('admin_page_photo');

    Route::post('/admin/page/photo-gallery/update', [AdminPageController::class, 'photo_gallery_update'])->name('admin_page_photo_update');
    ...
    Route::get('/admin/page/subcriber/show', [AdminSubcribeController::class, 'show'])->name('admin_subcriber_show');

    Route::get('/admin/page/subcriber/send-email', [AdminSubcribeController::class, 'send_email'])->name('admin_subcriber_send_email');

    Route::post('/admin/page/subcriber/send-email-submit', [AdminSubcribeController::class, 'send_email_submit'])->name('admin_subcriber_send_email_submit');
